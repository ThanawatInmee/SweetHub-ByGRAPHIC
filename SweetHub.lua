		...
		function CheckLevel()
			...
			if Old_World then
				...
				elseif Lv == 120 or Lv <= 149 or SelectMonster == "Chief Petty Officer [Lv. 120]" then -- Chief Petty Officer
					...
					CFrameMon = CFrame.new(-4931.1552734375, 65.793980758046, 4121.8393554688)
...
function Dis()
    ...
    elseif Three_World then
        repeat wait(.2)
			Mix_Farm = true
            TP(CFrame.new(-220.47939807580406, 5.787939807580409, 5324.3720703125))
        until (Vector3.new(-220.47939807580406, 5.787939807580409, 5324.3720703125)-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2
        wait(1)
		for i2,v2 in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do  
			if tostring(v2.ToolTip) == "Melee" then
				EquipWeapon(v2.Name)
...
elseif Three_World  then
    ...
    Island_Tab:Button("Castle on the Sea", function()
        TP2(CFrame.new(-5498.0458984375, 313.79398075804, -2860.6022949219))
    end)
